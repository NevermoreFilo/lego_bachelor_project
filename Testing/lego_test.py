...
def open_gripper():
    ...
    goal = franka_gripper.msg.MoveGoal(width=2*legoWidth+openOffSet, speed=0.05)
    # goal.width = 0.022
    # goal.speed = 1.0
...
def open_gripper2():
    ...
    # Creates a goal to send to the action server.
    goal = franka_gripper.msg.MoveGoal(width=legoWidth+openOffSet, speed=0.05)
    # goal.width = 0.022
    # goal.speed = 1.0
...
def close_gripper():
    ...
    # Creates a goal to send to the action server.
    goal = franka_gripper.msg.GraspGoal(width= 2*legoWidth - closedOffset, speed=0.05, force=10)
